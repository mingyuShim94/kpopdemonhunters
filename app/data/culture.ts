...
export const mythologyAndFolklore: CultureItem[] = [
  {
    name: "Korean Shamanism (Mudang)",
    description:
    ...
    filmConnection:
      "The members of HUNTR/X use their singing voices to create a magical barrier called the Honmoon, directly reflecting the protective rituals of mudang.",
    filmImage: "/images/culture/mythology/shamanism-film.webp",
    realityImage: "/images/culture/mythology/shamanism-reality.webp",
  },
  {
    name: "Grim Reapers (Jeoseung Saja)",
    description:
      "In Korean mythology, Jeoseung Saja are the grim reapers or messengers of the afterlife. They guide souls to the underworld.",
    filmConnection:
      "The rival boy band, the Saja Boys, are named after these figures. Their charming idol appearance hides their true demonic nature as they steal the souls of their fans.",
    filmImage: "/images/culture/mythology/saja-film.webp",
    realityImage: "/images/culture/mythology/saja-reality.webp",
  },
  {
    name: "Hojakdo (Tiger and Magpie Painting)",
    description:
    ...
    filmConnection:
      "The 'derpy' tiger, a breakout character, is a direct reference to Hojakdo paintings. This character, an oversized blue cat with a snaggletooth grin, is the pet of Jinu, the leader of the Saja Boys, adding a layer of Korean art history to the film.",
    filmImage: "/images/culture/mythology/hojakdo-film.webp",
    realityImage: "/images/culture/mythology/hojakdo-reality.webp",
  },
  {
    name: "Sacred Weapons and Items",
    description:
    ...
    filmConnection:
      "The hunters wield weapons like the saingeom (a double-edged sword) and woldo (a polearm), and wear accessories like norigae (traditional pendants) that are woven into their costumes and weaponry.",
    filmImage: "/images/culture/mythology/weapons-film.webp",
    realityImage: "/images/culture/mythology/weapons-reality.webp",
  },
];
...
export const kpopCulture: CultureItem[] = [
  {
    ...
    filmImage: "/images/culture/kpop/placards-slogans-film.webp",
    realityImage: "/images/culture/kpop/placards-slogans-reality.webp",
  },
  {
    ...
    filmImage: "/images/culture/kpop/fansign-event-film.webp",
    realityImage: "/images/culture/kpop/fansign-event-reality.webp",
  },
  {
    ...
    filmImage: "/images/culture/kpop/weekly-idol-film.webp",
    realityImage: "/images/culture/kpop/weekly-idol-reality.webp",
  },
  {
    ...
    filmImage: "/images/culture/kpop/music-show-film.webp",
    realityImage: "/images/culture/kpop/music-show-reality.webp",
  },
];

export const koreanFoods: CultureItem[] = [
  {
    name: "Kimbap",
    description:
      "Rice, vegetables, and protein rolled in seaweed. A staple comfort food.",
    filmConnection:
      "The members of HUNTR/X are often seen eating kimbap to fuel up for their battles.",
    filmImage: "/images/culture/food/kimbap-film.webp",
    realityImage: "/images/culture/food/kimbap-reality.webp",
  },
  {
    name: "Ramyeon",
    description:
      "The characters are seen eating cup ramyeon, a quick and popular meal in Korea.",
    filmConnection:
      "A go-to snack for the group during late-night training sessions.",
    filmImage: "/images/culture/food/ramyeon-film.webp",
    realityImage: "/images/culture/food/ramyeon-reality.webp",
  },
  {
    name: "Hotteok",
    description:
    ...
    filmImage: "/images/culture/food/hotteok-film.webp",
    realityImage: "/images/culture/food/hotteok-reality.webp",
  },
  {
    name: "Seolleongtang",
    description:
      "A comforting ox-bone soup that the characters eat during a difficult moment.",
    filmConnection:
      "Shared by the team after a tough battle, symbolizing healing and camaraderie.",
    filmImage: "/images/culture/food/seolleongtang-film.webp",
    realityImage: "/images/culture/food/seolleongtang-reality.webp",
  },
];

export const koreanPlaces: CultureItem[] = [
  {
    name: "N Seoul Tower",
    description:
      "This iconic tower appears at the end of the film, symbolizing hope and the city's resilience.",
    filmConnection: "A key landmark in the final scenes of the movie.",
    filmImage: "/images/culture/places/seoul-tower-film.webp",
    realityImage: "/images/culture/places/seoul-tower-reality.webp",
  },
  {
    ...
    filmImage: "/images/culture/places/bukchon-hanok-village-film.webp",
    realityImage: "/images/culture/places/bukchon-hanok-village-reality.webp",
  },
  {
    name: "COEX 3D Screen",
    description:
      "This massive digital billboard is featured when the group launches a new song.",
    filmConnection:
      "HUNTR/X's new music video is showcased on this iconic screen.",
    filmImage: "/images/culture/places/coex-screen-film.webp",
    realityImage: "/images/culture/places/coex-screen-reality.webp",
  },
  {
    name: "Naksan Park",
    description:
      "A pivotal conversation between two characters takes place at this park, known for its views and historic city walls.",
    filmConnection:
      "A moment of emotional connection and decision-making for the characters.",
    filmImage: "/images/culture/places/naksan-park-film.webp",
    realityImage: "/images/culture/places/naksan-park-reality.webp",
  },
];
...
export type CultureCategoryKey = keyof typeof cultureCategories;
